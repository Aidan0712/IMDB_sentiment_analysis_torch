...
from peft import PromptTuningConfig, get_peft_model, prepare_model_for_kbit_training, TaskType
...
if __name__ == '__main__':
    ...
    result_output.to_csv("./result/deberta_prompt_base.csv", index=False, quoting=3)
