...
from peft import PromptEncoderConfig, get_peft_model, prepare_model_for_kbit_training, TaskType
...
if __name__ == '__main__':
    ...
    result_output.to_csv("./result/deberta_ptuning_base.csv", index=False, quoting=3)
